<?php
if ( ! function_exists( 'iva_bhp_shortcode' ) ) {
	function iva_bhp_shortcode( $atts, $content = null ) {
		...
		$out = $output = $today_output = $iva_bh_single_day = $toggle_output = $iva_algncenter_hrs = $iva_bh_algn_class = $iva_holidays_date_text = $iva_custom_width = $iva_oc_title = $custom_width_css = '';
		global $wpdb;
	...
	add_shortcode( 'iva_bhrs', 'iva_bhp_shortcode' );
}
